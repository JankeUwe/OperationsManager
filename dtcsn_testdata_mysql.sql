-- ============================================================
-- dtcSN -- Testdaten fuer IONOS PHP-Demo (MySQL)
-- Erstellt:  Uwe Janke, dtcSoftware  2026-05-24
-- Zweck:     Identische Phantasiedaten wie dtcsn_testdata_mssql.sql,
--            konvertiert fuer MySQL 5.7 / 8.0
--
-- Ausfuehren: einmalig auf der IONOS-MySQL-Instanz
-- Idempotent: DELETE + INSERT, kann wiederholt werden
--
-- Hinweise MySQL vs. MSSQL:
--   - Kein IDENTITY / DBCC CHECKIDENT -> AUTO_INCREMENT, aber
--     explizite IDs werden direkt eingefuegt (kein IDENTITY_INSERT)
--   - Kein NVARCHAR -> VARCHAR / TEXT
--   - Kein UNIQUEIDENTIFIER/NEWID() -> CHAR(36) / UUID()
--   - Datumsformat: 'YYYY-MM-DD' (wie MSSQL)
--   - Kein GO -> Statements mit ; trennen
--   - Backtick-Quoting statt eckige Klammern
--   - TRUNCATE TABLE statt DELETE (FK-sichere Reihenfolge beachten)
-- ============================================================
...
INSERT INTO `SQLVersion` (`productversion`, `sqlversion`) VALUES
('16.', '2022'),
('15.', '2019'),
('14.', '2017'),
('13.', '2016'),
...
INSERT INTO `Support` (`VersionNr`, `ReleaseDate`, `EndOfMainstream`, `EndofExtended`) VALUES
...
TRUNCATE TABLE `ManagedSQLEntityType`;

INSERT INTO `ManagedSQLEntityType`
...
TRUNCATE TABLE `ManagedEntityCompType`;

INSERT INTO `ManagedEntityCompType` (`ManagedEntityTypeRowId`, `ManagedEntityTypeSystemName`) VALUES
...
TRUNCATE TABLE `ManagedEntityDatabaseType`;

INSERT INTO `ManagedEntityDatabaseType`
...
VALUES
(300, UUID(), 1, 'Microsoft.SQLServer.2022.Database', 'SQL Server 2022 Datenbank', 'SQL Server 2022 User Database', 1),
(301, UUID(), 1, 'Microsoft.SQLServer.2019.Database', 'SQL Server 2019 Datenbank', 'SQL Server 2019 User Database', 1),
(302, UUID(), 1, 'Microsoft.SQLServer.2017.Database', 'SQL Server 2017 Datenbank', 'SQL Server 2017 User Database', 1),
(303, UUID(), 1, 'Microsoft.SQLServer.2016.Database', 'SQL Server 2016 Datenbank', 'SQL Server 2016 User Database', 1);

-- ── 6. ExcludeDB ───────────────────────────────────────────
TRUNCATE TABLE `ExcludeDB`;

INSERT INTO `ExcludeDB` (`Name`) VALUES
('master'), ('model'), ('msdb'), ('tempdb'), ('ReportServer'), ('ReportServerTempDB');

-- ── 7. Customer ────────────────────────────────────────────
TRUNCATE TABLE `Customer`;

INSERT INTO `Customer` (`Id`, `Name`, `NameLong`, `Address`, `Zip`, `City`, `Notes`) VALUES
(1, 'Metallwerk', 'Metallwerk Rheintal AG',         'Industriestr. 12',  '47229', 'Duisburg',   'Produktion, 3-Schicht'),
(2, 'Stadtwerke', 'Stadtwerke Nord GmbH',           'Am Stadttor 3',     '24103', 'Kiel',       'Versorgung, kritische Infrastruktur'),
(3, 'Logistik',   'Schnell & Sicher Logistik GmbH', 'Hafenring 77',      '20457', 'Hamburg',    'Spedition, 24/7'),
(4, 'Pharma',     'BioMed Pharma GmbH',             'Forschungsallee 5', '69120', 'Heidelberg', 'GxP-Umgebung'),
(5, 'Handel',     'Euro-Handel AG',                 'Kaufhausring 1',    '80331', 'Muenchen',   'ERP-Betrieb');

-- ── 8. CustomerDomain ──────────────────────────────────────
TRUNCATE TABLE `CustomerDomain`;

INSERT INTO `CustomerDomain` (`CustomerId`, `DomainDnsName`, `JumpServer1`, `JumpServer2`, `Notes`) VALUES
...
-- ── 9. SQLServer ───────────────────────────────────────────
TRUNCATE TABLE `SQLDatabase`;
TRUNCATE TABLE `Computer`;
TRUNCATE TABLE `SQLServer`;
...
VALUES
-- MWSQL01 (1001)
(3001, 1001, 300, '16.0.4120.1:MWSQL01:Produktion',       'Produktion',      'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3002, 1001, 300, '16.0.4120.1:MWSQL01:MES',              'MES',             'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3003, 1001, 300, '16.0.4120.1:MWSQL01:Qualitaet',        'Qualitaet',       'Latin1_General_CI_AS',  1, 0, 'sa', 'SIMPLE', 'READ_WRITE', 'MULTI_USER'),
(3004, 1001, 300, '16.0.4120.1:MWSQL01:Archiv2022',       'Archiv2022',      'Latin1_General_CI_AS',  0, 0, 'sa', 'SIMPLE', 'READ_ONLY',  'MULTI_USER'),
-- MWSQL02 (1002)
(3005, 1002, 301, '15.0.4355.3:MWSQL02:Warenwirtschaft',  'Warenwirtschaft', 'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3006, 1002, 301, '15.0.4355.3:MWSQL02:Einkauf',          'Einkauf',         'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3007, 1002, 301, '15.0.4355.3:MWSQL02:Personal',         'Personal',        'German_PhoneBook_CI_AS',1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
-- MWSQL03\PROD (1003)
(3008, 1003, 302, '14.0.3465.1:MWSQL03:Fertigung',        'Fertigung',       'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3009, 1003, 302, '14.0.3465.1:MWSQL03:PPS',              'PPS',             'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3010, 1003, 302, '14.0.3465.1:MWSQL03:Instandhaltung',   'Instandhaltung',  'Latin1_General_CI_AS',  1, 0, 'sa', 'SIMPLE', 'READ_WRITE', 'MULTI_USER'),
-- SWN-SQL01 (1004)
(3011, 1004, 301, '15.0.4355.3:SWN-SQL01:Kundendaten',    'Kundendaten',     'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3012, 1004, 301, '15.0.4355.3:SWN-SQL01:Abrechnung',     'Abrechnung',      'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3013, 1004, 301, '15.0.4355.3:SWN-SQL01:Netz',           'Netz',            'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3014, 1004, 301, '15.0.4355.3:SWN-SQL01:SCADA',          'SCADA',           'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
-- SWN-SQL02 (1005)
(3015, 1005, 300, '16.0.4120.1:SWN-SQL02:DWH',            'DWH',             'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3016, 1005, 300, '16.0.4120.1:SWN-SQL02:Reporting',      'Reporting',       'Latin1_General_CI_AS',  1, 0, 'sa', 'SIMPLE', 'READ_ONLY',  'MULTI_USER'),
-- SSL-DB01 (1006)
(3017, 1006, 300, '16.0.4120.1:SSL-DB01:Transport',       'Transport',       'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3018, 1006, 300, '16.0.4120.1:SSL-DB01:Disposition',     'Disposition',     'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3019, 1006, 300, '16.0.4120.1:SSL-DB01:Fahrer',          'Fahrer',          'Latin1_General_CI_AS',  1, 0, 'sa', 'SIMPLE', 'READ_WRITE', 'MULTI_USER'),
-- SSL-DB02 (1007)
(3020, 1007, 303, '13.0.6441.1:SSL-DB02:Archiv',          'Archiv',          'Latin1_General_CI_AS',  0, 0, 'sa', 'SIMPLE', 'READ_ONLY',  'MULTI_USER'),
(3021, 1007, 303, '13.0.6441.1:SSL-DB02:Lager',           'Lager',           'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
-- BMP-SQLGXP01 (1008)
(3022, 1008, 301, '15.0.4355.3:BMP-SQLGXP01:LIMS',        'LIMS',            'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3023, 1008, 301, '15.0.4355.3:BMP-SQLGXP01:QMS',         'QMS',             'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3024, 1008, 301, '15.0.4355.3:BMP-SQLGXP01:Validierung', 'Validierung',     'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
-- BMP-SQLGXP02 (1009)
(3025, 1009, 301, '15.0.4355.3:BMP-SQLGXP02:Produktion',  'Produktion',      'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3026, 1009, 301, '15.0.4355.3:BMP-SQLGXP02:Forschung',   'Forschung',       'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
-- BMP-SQLREP01 (1010)
(3027, 1010, 300, '16.0.4120.1:BMP-SQLREP01:Reports',     'Reports',         'Latin1_General_CI_AS',  1, 0, 'sa', 'SIMPLE', 'READ_ONLY',  'MULTI_USER'),
-- EH-ERPDB01 (1011)
(3028, 1011, 300, '16.0.4120.1:EH-ERPDB01:ERP',           'ERP',             'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3029, 1011, 300, '16.0.4120.1:EH-ERPDB01:CRM',           'CRM',             'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3030, 1011, 300, '16.0.4120.1:EH-ERPDB01:Einkauf',       'Einkauf',         'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3031, 1011, 300, '16.0.4120.1:EH-ERPDB01:Vertrieb',      'Vertrieb',        'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
-- EH-ERPDB02 (1012)
(3032, 1012, 302, '14.0.3465.1:EH-ERPDB02:ERP_Archiv',    'ERP_Archiv',      'Latin1_General_CI_AS',  0, 0, 'sa', 'SIMPLE', 'READ_ONLY',  'MULTI_USER'),
(3033, 1012, 302, '14.0.3465.1:EH-ERPDB02:Fibu',          'Fibu',            'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
-- EH-RPTSQL01 (1013)
(3034, 1013, 301, '15.0.4355.3:EH-RPTSQL01:DWH',          'DWH',             'Latin1_General_CI_AS',  1, 1, 'sa', 'FULL',   'READ_WRITE', 'MULTI_USER'),
(3035, 1013, 301, '15.0.4355.3:EH-RPTSQL01:Analyse',      'Analyse',         'Latin1_General_CI_AS',  1, 0, 'sa', 'SIMPLE', 'READ_ONLY',  'MULTI_USER');

-- ── Abschluss ─────────────────────────────────────────────
SET FOREIGN_KEY_CHECKS = 1;

SELECT 'Customer'               AS Tabelle, COUNT(*) AS Zeilen FROM Customer
UNION ALL SELECT 'CustomerDomain',           COUNT(*) FROM CustomerDomain
UNION ALL SELECT 'SQLVersion',               COUNT(*) FROM SQLVersion
UNION ALL SELECT 'Support',                  COUNT(*) FROM Support
UNION ALL SELECT 'ManagedSQLEntityType',     COUNT(*) FROM ManagedSQLEntityType
UNION ALL SELECT 'ManagedEntityCompType',    COUNT(*) FROM ManagedEntityCompType
UNION ALL SELECT 'ManagedEntityDatabaseType',COUNT(*) FROM ManagedEntityDatabaseType
UNION ALL SELECT 'ExcludeDB',                COUNT(*) FROM ExcludeDB
UNION ALL SELECT 'SQLServer',                COUNT(*) FROM SQLServer
UNION ALL SELECT 'Computer',                 COUNT(*) FROM Computer
UNION ALL SELECT 'SQLDatabase',              COUNT(*) FROM SQLDatabase
ORDER BY 1;
