...
--
-- Fixes 2026-05-24:
--   - Alle DELETEs am Anfang in FK-sicherer Reihenfolge
--     (CustomerDomain vor Customer, SQLDatabase vor SQLServer)
--   - Datumsliterale ohne Trennzeichen (YYYYMMDD) wegen
--     deutschem Servergebietsschema
-- ============================================================

PRINT 'dtcSN Testdaten -- Start'
PRINT ''

-- ── Alle Abhaengigkeiten in FK-sicherer Reihenfolge loeschen ──
PRINT 'Bestehende Daten loeschen (FK-sichere Reihenfolge)...'
DELETE FROM [dbo].[SQLDatabase]
...
-- IDENTITY-Zaehler zuruecksetzen
...
(2022, '20221116', '20280111', '20330111'),
(2019, '20191104', '20250228', '20300108'),
(2017, '20171002', '20221011', '20271012'),
(2016, '20160601', '20210713', '20260714'),
(2014, '20140401', '20190709', '20240709'),
(2012, '20120306', '20170711', '20220712')
GO
...
-- CustomerId 1=Metallwerk, 2=Stadtwerke, 3=Logistik, 4=Pharma, 5=Handel
...
-- ── 9. SQLServer ───────────────────────────────────────────
PRINT '[9] SQLServer...'
-- ManagedEntityRowId wird explizit angegeben (kein IDENTITY-Konflikt,
-- da SQLServer.ID das IDENTITY-Feld ist, ManagedEntityRowId ist ein
-- normales BIGINT-Feld fuer die SCOM-Referenz)
...
(1001, 2001, 'MWSQL01',       'metallwerk.local',    'MWSQL01',     'MSSQLSERVER', 'MWSQL01',            'Standalone', '16.0.4120.1', 'RTM', 'Developer Edition (64-bit)',  '1433', 'metallwerk\sqlsvc',     'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'C:\MSSQL\DATA', 'C:\Program Files\Microsoft SQL Server', 1, '20240115', 42),
(1002, 2002, 'MWSQL02',       'metallwerk.local',    'MWSQL02',     'MSSQLSERVER', 'MWSQL02',            'Standalone', '15.0.4355.3', 'CU',  'Standard Edition (64-bit)',   '1433', 'metallwerk\sqlsvc',     'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'D:\MSSQL\DATA', 'C:\Program Files\Microsoft SQL Server', 1, '20230601', 18),
(1003, 2003, 'MWSQL03\PROD',  'metallwerk-prod.de',  'MWSQL03',     'PROD',        'MWSQL03\PROD',       'Standalone', '14.0.3465.1', 'CU',  'Enterprise Edition (64-bit)', '1433', 'METALLWERK-PROD\sqlsvc','Windows', '3', 'E:\SQL\Binn',                           'E:\SQL\DATA',   'E:\SQL\Tools',                          1, '20221101', 97),
-- Stadtwerke: 2 SQL Server
(1004, 2004, 'SWN-SQL01',     'stadtwerke-nord.lan', 'SWN-SQL01',   'MSSQLSERVER', 'SWN-SQL01',          'Standalone', '15.0.4355.3', 'CU',  'Standard Edition (64-bit)',   '1433', 'swn\sqlservice',        'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'C:\MSSQL\DATA', 'C:\Program Files\Microsoft SQL Server', 1, '20230910', 55),
(1005, 2005, 'SWN-SQL02',     'stadtwerke-nord.lan', 'SWN-SQL02',   'MSSQLSERVER', 'SWN-SQL02',          'Standalone', '16.0.4120.1', 'RTM', 'Enterprise Edition (64-bit)', '1433', 'swn\sqlservice',        'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'D:\SQL\DATA',   'C:\Program Files\Microsoft SQL Server', 1, '20240301', 12),
-- Logistik: 2 SQL Server
(1006, 2006, 'SSL-DB01',      'ssl-logistik.intern', 'SSL-DB01',    'MSSQLSERVER', 'SSL-DB01',           'Standalone', '16.0.4120.1', 'RTM', 'Standard Edition (64-bit)',   '1433', 'ssl\sqlsvc',            'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'F:\DATA',       'C:\Program Files\Microsoft SQL Server', 1, '20240214', 8),
(1007, 2007, 'SSL-DB02',      'ssl-logistik.intern', 'SSL-DB02',    'MSSQLSERVER', 'SSL-DB02',           'Standalone', '13.0.6441.1', 'SP3', 'Standard Edition (64-bit)',   '1433', 'ssl\sqlsvc',            'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'G:\DATA',       'C:\Program Files\Microsoft SQL Server', 1, '20210701', 201),
-- Pharma: 3 SQL Server (GxP, daher Enterprise)
(1008, 2008, 'BMP-SQLGXP01',  'biomed.corp',         'BMP-SQLGXP01','MSSQLSERVER', 'BMP-SQLGXP01',       'Standalone', '15.0.4355.3', 'CU',  'Enterprise Edition (64-bit)', '1433', 'biomed\sqlservice',     'Mixed',   '3', 'D:\MSSQL\Binn',                         'D:\MSSQL\DATA', 'D:\MSSQL\Tools',                        1, '20230401', 33),
(1009, 2009, 'BMP-SQLGXP02',  'biomed.corp',         'BMP-SQLGXP02','MSSQLSERVER', 'BMP-SQLGXP02',       'Standalone', '15.0.4355.3', 'CU',  'Enterprise Edition (64-bit)', '1433', 'biomed\sqlservice',     'Mixed',   '3', 'D:\MSSQL\Binn',                         'D:\MSSQL\DATA', 'D:\MSSQL\Tools',                        1, '20230401', 29),
(1010, 2010, 'BMP-SQLREP01',  'biomed.corp',         'BMP-SQLREP01','REPORT',       'BMP-SQLREP01\REPORT','Standalone', '16.0.4120.1', 'RTM', 'Standard Edition (64-bit)',   '1433', 'biomed\sqlsvc',         'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'C:\SQL\DATA',   'C:\Program Files\Microsoft SQL Server', 1, '20240120', 5),
-- Handel: 3 SQL Server
(1011, 2011, 'EH-ERPDB01',    'eurohandel.local',    'EH-ERPDB01',  'MSSQLSERVER', 'EH-ERPDB01',         'Standalone', '16.0.4120.1', 'RTM', 'Enterprise Edition (64-bit)', '1433', 'eurohandel\sqlsvc',     'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'E:\MSSQL\DATA', 'C:\Program Files\Microsoft SQL Server', 1, '20240110', 67),
(1012, 2012, 'EH-ERPDB02',    'eurohandel.local',    'EH-ERPDB02',  'MSSQLSERVER', 'EH-ERPDB02',         'Standalone', '14.0.3465.1', 'CU',  'Standard Edition (64-bit)',   '1433', 'eurohandel\sqlsvc',     'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'F:\MSSQL\DATA', 'C:\Program Files\Microsoft SQL Server', 1, '20220515', 144),
(1013, 2013, 'EH-RPTSQL01',   'eurohandel.local',    'EH-RPTSQL01', 'MSSQLSERVER', 'EH-RPTSQL01',        'Standalone', '15.0.4355.3', 'CU',  'Standard Edition (64-bit)',   '1433', 'eurohandel\sqlsvc',     'Windows', '2', 'C:\Program Files\Microsoft SQL Server', 'G:\MSSQL\DATA', 'C:\Program Files\Microsoft SQL Server', 1, '20230801', 22)
GO
